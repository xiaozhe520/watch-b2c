...
<div id="header-div">
	...
	<div id="submenu-div">
		<ul>
			  <li><a href="{{ URL::asset('admin/index') }}?act=about_us" target="main-frame">关于本店</a></li>
			  ...
			  <li style="border-left:none;"><a href="{{ URL::asset('admin/index') }}?act=first" target="main-frame">开店向导</a></li>
		</ul>
		<div id="send_info" style="padding: 5px 10px 0 0; clear:right;text-align: right; color: #FF9900;width:40%;float: right;">
			<a href="{{ URL::asset('admin/index') }}?act=clear_cache" target="main-frame" class="fix-submenu">清除缓存</a>
			<a href="{{ URL::asset('images/ecshop_logo.gif') }}privilege.php?act=logout" target="_top" class="fix-submenu">退出</a>
		</div>
	</div>
</div>
</body>
