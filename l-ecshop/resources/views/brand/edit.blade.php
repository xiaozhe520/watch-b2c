...
<h1>
<span class="action-span"><a href="{{url('brand/brand_list')}}">商品品牌</a></span>
<span class="action-span1"><a href="{{url('admin/index')}}">SHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 编辑品牌信息 </span>
<div style="clear:both"></div>
</h1>

<div class="main-div">
<form method="post" action="edit_do" name="theForm" enctype="multipart/form-data" onsubmit="">
<table cellspacing="1" cellpadding="3" width="100%">
{{csrf_field()}}
  <tbody><tr>
    <td class="label">品牌名称</td>act
  ...
  <tr>
    ...
    <td><textarea name="brand_desc" cols="60" rows="4" value="<?php echo $data->brand_desc ?>"></textarea></td>
  </tr>
  <tr>
    <td class="label">排序</td>
    <td><input type="text" name="sort_order" maxlength="40" size="15" value="<?php echo $data->sort_order ?>"></td>
  </tr>
  <tr>
