...
<h1>
<span class="action-span"><a href="{{url('brand/list')}}">商品品牌</a></span>
<span class="action-span1"><a href="{{url('admin/index')}}">SHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 添加品牌 </span>
<div style="clear:both"></div>
</h1>

<div class="main-div">
<form method="post" action="{{url('brand/add')}}" name="theForm" enctype="multipart/form-data" onsubmit="return validate()">
