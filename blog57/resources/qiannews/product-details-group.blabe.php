                ...
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <ul class="breadcrumb justify-content-center">
                            ...
                            <li class="current"><a href="product-details.html">Group Product Detalis</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="product-quantity">
                                                                <span>Quantity</span>
                                                                <div class="quantity">
                                                                    <input type="number" class="quantity-input" name="qty" id="qty2" value="1" min="1">
                                                                </div>
                                                            </td>
                                                            <td class="product-name">
