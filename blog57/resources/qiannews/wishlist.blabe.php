                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><a href="cart.html" class="btn add-to-cart btn-medium btn-style-2">Add to Cart</a></td>
                                                </tr>
                                                <tr>
                                                    <td><a class="delete" href="#"><i class="fa fa-times"></i></a></td>
                                                    <td>
                                                    ...
                                                    <td><a href="cart.html" class="btn disabled add-to-cart btn-medium btn-style-2">Add to Cart</a></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
