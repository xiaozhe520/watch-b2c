        ...
        <header class="header header-style-2">
            <div class="header-top header-top-2">
                <div class="container">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-md-8 col-sm-6 text-center text-sm-right">
            ...
            <div class="header-middle header-middle-2">
                <div class="container">
                    <div class="row no-gutters align-items-center">
                        <div class="col-lg-4">
                            <a href="index.html" class="logo-box text-lg-left text-center mb-md--30">
        ...
        <div class="main-content-wrapper">
            ...
            <div class="slider-area">
                <div class="homepage-slider">
                    <!-- Single Slide Start -->
                    <div class="single-slider content-v-center" style="background-image: url(assets/img/slider/slider1-mirora2-1920x634.jpg)">
                        <div class="container">
                            <div class="row">
                                <div class="col-12">
                    ...
                    <!-- Single Slide Start -->
                    <div class="single-slider content-v-center" style="background-image: url(assets/img/slider/slider3-mirora2-1920x634.jpg)">
                        <div class="container">
                            <div class="row">
                                <div class="col-12">
                                    <div class="slider-content">
