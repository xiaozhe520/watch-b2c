...
<body>
    ...
    <!-- Main Wrapper Start -->
    <div class="wrapper sidenav-wrapper bg--shaft">
        <!-- Header Area Start -->
        <header class="header header-style-3">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col-lg-5 col-md-4">
                            <div class="header-top-nav d-flex align-items-center">
                                <a href="#" class="sidenav-button sidenav-open">
                                    <span></span>
                                </a>
                        ...
                        <div class="col-lg-7 col-md-8 text-right">
                            <div class="header-toolbar header-toolbar-3">
                                <div class="search-form-wrapper search-form-wrapper-3">
                                    <form action="#" class="search-form search-form-3">
                                ...
                                <ul class="header-toolbar-icons">
                                    <li class="my-account-icon dropdown">
                                        <a class="dropdown-toggle bordered-icon" id="userID" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="fa fa-cog"></i>
                                        </a>
            ...
            <div class="vertiacl-header">
                <a href="#" class="sidenav-button sidenav-close">
                    <span></span>
                </a>
                <div class="vertiacl-header-wrapper">
                    <div class="header-inner" id="verticalHeader">
                        <div class="logo-container">
                            <a href="index.html" class="logo-box">
                                <img src="assets/img/logo/logo.png" alt="Logo">
                            </a>
                        </div>
                        <div class="side-navigation mb--50 pb--90 mb-md--40 pb-md-70">
                            <ul class="vertical-menu">
                                <li class="vertical-menu__item vertical-has-children">
                                    <a href="index.html" class="vertical-menu__link">Home</a>
                                    <ul class="sub-menu">
                                ...
                                <li class="vertical-menu__item vertical-has-children">
                                    <a href="shop.html" class="vertical-menu__link">Shop</a>
                                    <ul class="sub-menu">
                                        <li class="vertical-has-children">
                                        ...
                                        <li class="vertical-has-children">
                                            <a href="shop.html">Single Product</a>
                                            <ul class="sub-menu">
                                                <li>
                                ...
                                <li class="vertical-menu__item vertical-has-children">
                                    <a href="#" class="vertical-menu__link">Pages</a>
                                    <ul class="sub-menu">
                                ...
                                <li class="vertical-menu__item vertical-has-children">
                                    <a href="#" class="vertical-menu__link">Blog</a>
                                    <ul class="sub-menu">
                                        <li class="vertical-has-children">
                                        ...
                                        <li class="vertical-has-children">
                                            <a href="blog-details-audio.html">Single Blog</a>
                                            <ul class="sub-menu">
                                                <li><a href="blog-details-audio.html">Audio Blog Details</a></li>
                                                <li><a href="blog-details-video.html">Video Blog Details</a></li>
                                                <li><a href="blog-details-image.html">Image Blog Details</a></li>
                                                <li><a href="blog-details-gallery.html">Gallery Blog Details</a></li>
                                ...
                                <li class="vertical-menu__item">
                                    <a href="about.html" class="vertical-menu__link">About Us</a>
                                </li>
                                <li class="vertical-menu__item">
                                    <a href="contact.html" class="vertical-menu__link">contact Us</a>
                                </li>
                            </ul>
                        </div>
                        <div class="newsletter-2 mb--50">
                            <h3>Newsletter</h3>
                            <p>Sign up for our newsletter.</p>
                            <form class="newsletter-form-2 validate mt--40" action="" method="post" id="mc-embedded-newsletter-form-3" name="mc-embedded-newsletter-form" target="_blank" novalidate="">
                                <input type="email" name="email" id="sub-email-2" placeholder="Enter your email address here..">
                                <button type="submit">
                                    <i class="fa fa-send"></i>
                                </button>
                            </form>
                        </div>
                        <ul class="social social-round mb--20">
                        ...
                        <p class="copyright-text">
                            Copyright &copy; 2018 <a href="">HasTech</a>.All Right Reserved
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="main-content-wrapper">
            ...
            <div class="slider-area">
                <div class="homepage-slider">
                    <!-- Single Slide Start -->
                    <div class="single-slider full-height content-v-center" style="background-image: url(assets/img/slider/slider1-mirora3-1620x909.jpg)">
                        <div class="container">
                            <div class="row">
                                <div class="col-12">
                    ...
                    <!-- Single Slide Start -->
                    <div class="single-slider full-height content-v-center" style="background-image: url(assets/img/slider/slider3-mirora3-1620x909.jpg)">
                        <div class="container">
                            <div class="row">
                                <div class="col-12">
                                    <div class="slider-content">
                                        <h5 data-animation="rollIn" data-duration=".8s" data-delay=".5s">Exclusive Offer -20% Off This Week</h5>
                                        <h1 data-animation="fadeInDown" data-duration=".8s" data-delay=".2s">Our Sale Continues</h1>
                                        <p class="mb--30 mb-sm-20" data-animation="fadeInDown" data-duration=".8s" data-delay=".2s">Christmas Might Be Over, But Our Sale Isn't. Up To 70% Off, With New Items Added.</p>
                                        <p class="mb--50 mb-sm--20" data-animation="fadeInDown" data-duration=".8s" data-delay=".2s">Starting At <strong>$1.499.00</strong></p>
                                        <div class="slide-btn-group" data-animation="fadeInUp" data-duration="1s" data-delay=".3s">
                                            <a href="shop.html" class="btn btn-bordered btn-style-1">Shop Now</a>
                                        </div>
            ...
            <div class="corporate-area border-top border-bottom ptb--80 ptb-md--60">
                <div class="container">
                    <div class="row">
            ...
            <section class="blog-area border-bottom ptb--80 ptb-md--60">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
