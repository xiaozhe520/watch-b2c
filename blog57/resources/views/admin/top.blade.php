...
<div id="header-div">
	...
	<div id="submenu-div">
		<ul>
			  <li><a href="{{ URL::asset('index/about_us') }}act=" target="main-frame">关于本店</a></li>
			  <li><a href="javascript:web_address();">帮助</a></li>
			  <li><a href="../" target="_blank">查看网店</a></li>
			  <li><a href="{{ URL::asset('message/list') }}" target="main-frame">管理员留言</a></li>
			  <li><a href="{{ URL::asset('privilege/modif') }}" target="main-frame">个人设置</a></li>
			  ...
			  <li style="border-left:none;"><a href="{{ URL::asset('index/first') }}" target="main-frame">开店向导</a></li>
		</ul>
		<div id="send_info" style="padding: 5px 10px 0 0; clear:right;text-align: right; color: #FF9900;width:40%;float: right;">
			<a href="{{ URL::asset('index/clear_cache') }}" target="main-frame" class="fix-submenu">清除缓存</a>
			<a href="{{ URL::asset('privilege/logout') }}" target="_top" class="fix-submenu">退出</a>
		</div>
	</div>
</div>
</body>
